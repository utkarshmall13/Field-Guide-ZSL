...
names = ['Traditional ZSL', 'W2V', 'CAAP', 'ZSLNS', 'ZSLNS+CADA-VAE', 'GAZSL', 'GAZSL+CADA-VAE']
colors = [palette[0], palette[1], palette[2], palette[3], palette[4], palette[5], palette[6]]

new_modes = ['acc_'+dataset+'__Falseinteractive_siblings+']
new_names = [	'ZSL-Interactive w/ Sibling-variance']

new_colors = palette[2:len(new_names)+2]
if oneshot:
	new_modes.pop()
