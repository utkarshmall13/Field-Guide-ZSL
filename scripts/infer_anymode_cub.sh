...
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 0 --test_mode $2+2 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 1 --test_mode $2+2 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 2 --test_mode $2+2 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 3 --test_mode $2+2 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 4 --test_mode $2+2 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 5 --test_mode $2+2 --train_mode $1 --num_shots $4  &
wait
...
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 0 --test_mode $2+6 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 1 --test_mode $2+6 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 2 --test_mode $2+6 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 3 --test_mode $2+6 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 4 --test_mode $2+6 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 5 --test_mode $2+6 --train_mode $1 --num_shots $4  &
wait
...
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 0 --test_mode $2+10 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 1 --test_mode $2+10 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 2 --test_mode $2+10 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 3 --test_mode $2+10 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 4 --test_mode $2+10 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 5 --test_mode $2+10 --train_mode $1 --num_shots $4  &
wait
...
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 0 --test_mode $2+28 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 1 --test_mode $2+28 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 2 --test_mode $2+28 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 3 --test_mode $2+28 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=0 python3 inference.py --dataset $3  --run 4 --test_mode $2+28 --train_mode $1 --num_shots $4  &
CUDA_VISIBLE_DEVICES=1 python3 inference.py --dataset $3  --run 5 --test_mode $2+28 --train_mode $1 --num_shots $4  &
wait
